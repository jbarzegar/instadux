...
export const convertToActionName = (domain: string, action: string) =>
  `${domain}_${action.toUpperCase()}`;

export const createAsyncResolvers = (
...
const defaultAsyncReducers = (actions: Actions) => ({
...
export const createDefaultReducers = (actions: Actions) => ({
